...
public class Principal extends Application {
  ...
  *************************************************************** */
  ...
  public void start(Stage stage) throws Exception {
    ...
    controllerCena1 = loader.getController(); // Obtém a referência ao controlador da cena 1
    controllerCena1.setControllerPrincipal(this); // Passa a referência para o controlador, se necessário
    ...
    stage.setOnCloseRequest(new EventHandler<WindowEvent>() {
      ...
      public void handle(WindowEvent event) {
        if (controllerCliente != null) {
          controllerCliente.encerrarAplicacao(); // Chama o método de encerramento do controllerCliente
        }//fim do if
      }//fim do handle
    });
  ...
  // Método que será chamado no ControllerCena1 para passar o controlador da próxima cena
